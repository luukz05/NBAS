...
//     fetch('https://api.sportsdata.io/v3/nba/scores/json/teams?key=ff9539313a194e2a95d215dd8cf26995')
//         .then(response => {
//             if (!response.ok) {
...
//                     fetch(`https://api.sportsdata.io/v3/nba/scores/json/PlayersBasic/${team.Key}?key=ff9539313a194e2a95d215dd8cf26995`)
//                         .then(response => {
//                             if (!response.ok) {
//                                 throw new Error(`Erro ao obter os jogadores para o time ${team.Name}`);
//                             }
//                             return response.json();
//                         })
//                         .then(players => {
...
//                                     playerItem.style.color = (normalizedPrimaryColor === 'FFF21F') ? '#000000' : '#ffffff'; // Texto preto para fundo claro
